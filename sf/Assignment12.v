...
Proof.
  unfold tloop, not, normal_form. 
  assert (forall t:tm, tapp (tfix (tabs Loop (TArrow TNat TNat) (tabs X TNat (tapp (tvar Loop) (tvar X))))) (tnat 0) ==>* t \/ exists t':tm, t ==> t').
  intros. 
    remember (exists t':tm, t ==> t').
    left.

    eapply multi_step.
      eapply ST_AppFix. apply v_abs. apply v_nat.
    eapply multi_step.
      eapply ST_App1. eapply ST_AppAbs. apply v_fix. apply v_abs. simpl.
    eapply multi_step.
      eapply ST_AppAbs. apply v_nat. simpl.
    ...
    eapply multi_step.
      eapply ST_AppFix. apply v_abs. apply v_nat.
    eapply multi_step.
      eapply ST_App1. apply ST_AppAbs. apply v_fix. apply v_abs. simpl.
    eapply multi_step.
      eapply ST_AppAbs. apply v_nat. simpl.
